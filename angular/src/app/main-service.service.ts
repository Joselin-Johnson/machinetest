...
export class MainServiceService {
  ...
  readonly APIUrl="http://localhost:9090/USTTraining/api";
  ...
  getVendorDetails(): Observable<VendorContactDetails[]>{
    return this._httpService.get<VendorContactDetails[]>(this.APIUrl+'/vendordetail/null');
  }
  ...
  {
    return this._httpService.get<VendorContactDetails[]>(this.APIUrl+'/vendordetail/'+searchString);
  }
  //add details
